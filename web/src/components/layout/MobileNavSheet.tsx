          ...
          {kind === 'workspaces' ? (
            ...
            <div className="space-y-4">
              {sessions.length === 0 ? (
                ...
                <>
                  <div className="space-y-2">
                    <p className="px-2 text-2xs font-medium uppercase tracking-wider text-muted-foreground">
                      Live
                    </p>
                    {sessions
                  ...
                  <div className="space-y-2">
                    <p className="flex items-center gap-2 px-2 text-2xs font-medium uppercase tracking-wider text-muted-foreground">
                      <History size={12} />
                      Previous
                    </p>
                    {sessions
