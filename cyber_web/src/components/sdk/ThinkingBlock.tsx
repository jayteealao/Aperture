...
export function ThinkingBlock({ thinking, isStreaming }: ThinkingBlockProps) {
  ...
  return (
    <div className="border border-purple-500/30 bg-purple-500/5 text-xs overflow-hidden">
      <button
      ...
      >
        ...
        <span className="text-[10px] text-hud-text/50 ml-auto">
          ~{estimatedTokens.toLocaleString()} tokens
        </span>
      </button>
      {isExpanded && (
        <div className="px-3 py-2 border-t border-purple-500/20 bg-hud-gray/20">
          <pre className={cn(
